...
namespace AkiraIEoRMusic
{
    ...
    public class MusicEventSystem : ModSystem
    {
        ...
        {
            if (ModLoader.HasMod("Selentia")) return;
            ...
            // Mutant Interlude
            AddEntry("MutantInterlude", "AkiraIEoRMusic/Music/Axion", TimeSpan.FromSeconds(156.37), () => WorldSavingSystem.DownedMutant, () => ModContent.GetInstance<MusicConfig>().MutantInterlude);
        }
        ...
        public override void PostUpdateTime()
        {
            ...
            if (TrackEnd is not null)
            {
                ...
                {
                    int silenceSlot = MusicLoader.GetMusicSlot("AkiraIEoRMusic/Music/Silence");
        ...
        {
            ModPacket packet = AkiraIEoRMusic.Instance.GetPacket();
            packet.Write((byte)MusicNetcode.MusicMessageType.MusicEventSyncRequest);
            packet.Send();
        }
        ...
        public static void FulfillSyncRequest(int requester)
        {
            ...
            ModPacket packet = AkiraIEoRMusic.Instance.GetPacket();
            packet.Write((byte)MusicNetcode.MusicMessageType.MusicEventSyncResponse);
