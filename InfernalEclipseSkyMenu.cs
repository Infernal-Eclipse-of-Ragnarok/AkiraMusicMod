...
namespace AkiraIEoRMusic
{
    public class InfernalEclipseSkyMenu : ModMenu
    {
        ...
        private const string MenuAssetPath = "AkiraIEoRMusic/Assets/Textures/Menu";
        ...
        public override int Music => MusicLoader.GetMusicSlot(Mod, "Music/TeardropsofDragonfire");
