...
namespace AkiraIEoRMusic
{
    ...
    {
        // Animated text with flowing fiery gradient
        public class AnimatedModName : UIText
        {
            ...
            private static string GetAnimatedText(string text, float time)
            {
                ...
                var startColor = new Color(180, 100, 150);
                var endColor = new Color(255, 165, 0);
        ...
        {
            // Color constants
            private static readonly Color StartGradientColor = new Color(26, 15, 46);
            private static readonly Color EndGradientColor = new Color(255, 165, 0);
            private static readonly Color Circle1Color = new Color(255, 200, 100, 160);
            private static readonly Color Circle2Color = new Color(255, 200, 100, 160);
            private static readonly Color Circle3Color = new Color(255, 200, 100, 160);
            private static readonly Color AnkhColor = new Color(255, 255, 255);
            ...
            protected override void DrawSelf(SpriteBatch spriteBatch)
            {
                ...
                var ankhTexture = ModContent.Request<Texture2D>("AkiraIEoRMusic/Assets/Panel/AnkhIcon").Value;
                var magicCircle = ModContent.Request<Texture2D>("AkiraIEoRMusic/Assets/Panel/MagicCircle").Value;
                ...
                // 2. Draw main ankh (on top of circles)
                float ankhScale = scale * AnkhScaleMultiplier;
                spriteBatch.Draw(
                    ankhTexture,
                    center,
                    ankhTexture.Frame(),
        ...
        public override void Load()
        {
            ...
            {
                panelShader = ModContent.Request<Effect>("AkiraIEoRMusic/Assets/Panel/PanelGradient", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
            }
        }
        ...
        public override bool PreDrawPanel(UIPanel element, SpriteBatch sb, ref bool drawDivider)
        {
            ...
            var borderColor = Color.Lerp(new Color(61, 40, 71), new Color(255, 165, 0), panelHoverIntensity * 0.5f);
