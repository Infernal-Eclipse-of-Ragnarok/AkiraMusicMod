    ...
    public class MusicDisplayIntergrationSystem : ModSystem
    {
        ...
        private static void MusicDisplaySetup()
        {
            if (ModLoader.TryGetMod("MusicDisplay", out Mod musicDisplay))
            {
                ...
                musicDisplay.Call("AddMusic", (short)MusicLoader.GetMusicSlot("AkiraIEoRMusic/Music/BereftVassal"), "Dead Kingdom's Champion", "by Techhy", "Infernal Eclipse of Ragnarok");

                musicDisplay.Call("AddMusic", (short)MusicLoader.GetMusicSlot("AkiraIEoRMusic/Music/Isolation"), "Isolation", "by NightHawk22", "");
